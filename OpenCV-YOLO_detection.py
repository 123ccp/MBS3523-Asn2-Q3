...
net = cv2.dnn.readNetFromDarknet('yolov_608.cfg', 'yolov3_608.weights')
...
while True:
    ...
    if len(indexes) > 0:
        ...
        cv2.putText(img, "There are: " + str(an) + " " + 'apple', (350, 30), font, 1, (255, 0, 0), 2)
        cv2.putText(img, "There are: " + str(bn) + " " + 'banana', (350, 60), font, 1, (255, 0, 0), 2)
        cv2.putText(img, "There are: " + str(on) + " " + 'orange', (350, 90), font, 1, (255, 0, 0), 2)
        finaltext=""
        if an>0:
            finaltext+=str(an)+"X3"
        if bn>0:
        ...
        if on>0:
            if bn>0 or an>0:
                finaltext+="+"
            finaltext+=str(on)+"X6"
        cv2.putText(img, "Total Price="+"$" + finaltext+"=" + str(round(an*3+bn*4+on*6, 2)), (350, 120), font, 1, (255, 0, 0), 2)
